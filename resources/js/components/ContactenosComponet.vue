                ...
                <div class="col-md-8">
                    <div class="section-title padbot-movil">
                        <h1 class="titulo-movil padtop20-movil"
                            style="color: #026633; font-weight: 300; font-size: 50px">
                            Contáctenos
                        </h1>
                    ...
                    <h3 class="nuevafuente subtitulo2-movil texto-separado vista" style="
                        display: none;
                        color: black;
                        font-weight: 600;
                        font-size: 20px;
                ...
                <div class="col-md-4">
                    <div class="sidebar" style="padding-left: 0px !important">
                        ...
                        <iframe class="mapa-movil"
                            ...
                            width="370" height="300" style="border: 0" :allowfullscreen="true" loading="lazy"
                    ...
                    <aside class="widget widget-help" style="
                        ...
                        <div class="row">
                            <div class="col-3" style="text-align: center; padding-right: 0px">
                                <i><img src="web/images/web/Ubicacionv2.png" style="padding: 10px" />
                                </i>
                                <br />
                                <i><img src="web/images/web/Emailv2.png"
                                        style="padding: 10px" /></i><br />
                                <i><img src="web/images/web/Phonev2.png"
                                        style="padding: 10px" /></i><br />
                                <i><img src="web/images/web/Movilv2.png" style="padding: 10px" /></i>
                            </div>
                            <div class="col-9" style="padding-left: 0px">
                                ...
                                <p class="nuevafuente2 martbot-movil"
                                    style="color: white; font-size: 12px; padding: 5px">
                                    hotelgraneden@gmail.com
                                </p>
                                <p class="nuevafuente2 martbot30-movil"
                                    style="color: #026633; font-size: 12px; padding: 15px 5px">
                                    9999999
                                </p>
