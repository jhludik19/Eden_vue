        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12 oculto">
                    <div class="sidebar martop-movil">
                        <aside class="widget noborder" style="margin-bottom: 30px">
                            <div class="vertical-booking-form"
                                style="background: #f5f3f0; border: none; padding-right: 30px">
                  ...
                  ">
                                    <button id="aguas" style="color: black"> Aguas termales </button>
                                </p>
                                <p class="nuevafuente texto-centrar" style="
                    color: black;
                    margin-left: 25px;
                    ...
                    letter-spacing: 0.5px;
                  ">
                                    <button id="restaurante" style="color: black"> Restaurante </button>
                                </p>
                                <p class="nuevafuente texto-centrar" style="
                    color: black;
                    margin-left: 25px;
                    ...
                    letter-spacing: 0.5px;
                  ">
                                    <button id="piscina" style="color: black">Piscina</button>
                                </p>
                                <p class="nuevafuente texto-centrar" style="
                    color: black;
                    margin-left: 25px;
                    ...
                    letter-spacing: 0.5px;
                  ">
                                    <button id="discoteca" style="color: black"> Discoteca </button>
                                </p>
                                <p class="nuevafuente texto-centrar" style="
                    color: black;
                    margin-left: 25px;
                    ...
                    letter-spacing: 0.5px;
                  ">
                                    <button id="campo" style="color: black"> Campo deportivo </button>
                                </p>
                                <p class="nuevafuente texto-centrar" style="
                    color: black;
                    margin-left: 25px;
                    ...
                    letter-spacing: 0.5px;
                  ">
                                    <button id="auditorio" style="color: black"> Auditorio </button>
                                </p>
                    ...
                    letter-spacing: 0.5px;
                  ">
                                    <button id="terraza" style="color: black">Terraza</button>
                                </p>
                                <p class="nuevafuente texto-centrar" style="
                    color: black;
                    margin-left: 25px;
                    ...
                    letter-spacing: 0.5px;
                  ">
                                    <button id="karaoke" style="color: black"> Karaoke </button>
                                </p>
                            </div>
                        </aside>

                        <aside class="widget widget-help oculto"
                            style="padding-left: 30px; background: #74bc21; padding-top: 30px">
              ...
              ">
                        ...
                        <div id="room-main-image" class="owl-carousel image-gallery pad010-movil">
                            <div class="item">
                                <figure class="gradient-overlay-hover image-icon">
                                    <a href="web/images/rooms/single/Piscina.jpg">
                                        <img class="img-fluid" src="web/images/rooms/single/Piscina.jpg" alt="Image" />
                                    </a>
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="room-slider" id="slider2">
                        <div id="room-main-image1" class="owl-carousel image-gallery pad010-movil">
                            <div class="item">
                                <figure class="gradient-overlay-hover image-icon">
                                    <a href="web/images/rooms/single/RestauranteNuevo.jpg">
                                        <img class="img-fluid" src="web/images/rooms/single/RestauranteNuevo.jpg"
                                            alt="Image" />
                                    </a>
                                </figure>
                            </div>
                        ...
                        <div id="room-thumbs1" class="room-thumbs owl-carousel">
                            <div class="item">
                                <img class="img-fluid" src="web/images/rooms/single/RestauranteNuevo.jpg" alt="Image" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="room-slider" id="slider3">
                        <div id="room-main-image2" class="owl-carousel image-gallery pad010-movil">
                            <div class="item">
                                <figure class="gradient-overlay-hover image-icon">
                                    <a href="web/images/rooms/single/Piscina02.jpg">
                                        <img class="img-fluid" src="web/images/rooms/single/Piscina02.jpg"
                                            alt="Image" />
                                    </a>
                                </figure>
                            </div>
                        ...
                        <div id="room-thumbs2" class="room-thumbs owl-carousel">
                            <div class="item">
                                <img class="img-fluid" src="web/images/rooms/single/Piscina02.jpg" alt="Image" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="room-slider" id="slider5">
                        <div id="room-main-image4" class="owl-carousel image-gallery pad010-movil">
                            <div class="item">
                                <figure class="gradient-overlay-hover image-icon">
                                    <a href="web/images/rooms/single/Campo.jpg">
                                        <img class="img-fluid" src="web/images/rooms/single/Campo.jpg" alt="Image" />
                                    </a>
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="room-slider" id="slider7">
                        <div id="room-main-image6" class="owl-carousel image-gallery pad010-movil">
                            <div class="item">
                                <figure class="gradient-overlay-hover image-icon">
                                    <a href="web/images/rooms/single/Baile.jpg">
                                        <img class="img-fluid" src="web/images/rooms/single/Baile.jpg" alt="Image" />
                                    </a>
                                </figure>
                            </div>
                        </div>
              ...
              margin-left: 15px;
            ">
                        Desconéctate en un lugar increíble con las personas que más quieres
                        y disfruta de la tranquilidad y paz de nuestro paraíso con un clima
                        privilegiado. En El Gran Edén podrás relajarte y divertirte como lo
                        mereces. <br />
                    </p>
                ...
                ">
                    ...
                    <p style="text-align: center">
                        <a href="#">
                            <img class="ancho" src="web/images/web/servicio01.png" alt="Image" style="width: 120px" />
                        </a>

                        <a href="#">
                            <img class="ancho" src="web/images/web/servicio02.png" alt="Image" style="width: 120px" />
                        </a>

                        <a href="#">
                            <img class="ancho" src="web/images/web/servicio03.png" alt="Image" style="width: 120px" />
                        </a>

                        <a href="#">
                            <img class="ancho" src="web/images/web/servicio04.png" alt="Image" style="width: 120px" />
                        </a>

                        <a href="#">
                            <img class="ancho" src="web/images/web/servicio05.png" alt="Image" style="width: 120px" />
                        </a>

                        <a href="#">
                            <img class="ancho" src="web/images/web/servicio06.png" alt="Image" style="width: 120px" />
                        </a>

                        <a href="#">
                            <img class="ancho" src="web/images/web/servicio07.png" alt="Image" style="width: 120px" />
                        </a>
                    </p>
                </div>
            </div>
