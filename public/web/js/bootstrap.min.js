...
!(function (t, e) {
        ...
        (p = (function () {
          ...
          return (
            ...
            (e._removeElement = function (t) {
              var e = this;
              o(t).removeClass(d),
                O.supportsTransitionEnd() && o(t).hasClass(u)
                  ? o(t)
          ...
          p = (function () {
            ...
            return (
              ...
              (p._getItemIndex = function (e) {
                return (
                  (this._items = t.makeArray(t(e).parent().find(d.ITEM))),
  ...
  function J() {
    ...
    return { height: Z("Height", t, e, n), width: Z("Width", t, e, n) };
  }
  var $ = function (t, e) {
      if (!(t instanceof e))
  ...
  function dt(t, e, n) {
    return (
      (void 0 === n
        ...
        t.enabled &&
          U(n) &&
          ((e.offsets.popper = it(e.offsets.popper)),
              ...
              s.forEach(function (a, l) {
                ...
                (d || v || b) &&
                  ...
                  (t.offsets.popper = nt(
                    {},
                    t.offsets.popper,
                    ft(t.instance.popper, t.offsets.reference, t.placement)
                  )),
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var s,
              ...
              p = gt("transform");
            if (
              ((a = "bottom" === u ? -c.height + f.bottom : f.top),
            ...
            return (
              (t.attributes = nt({}, _, t.attributes)),
          ...
          fn: function (t) {
            ...
            return (
              ...
              t.arrowElement &&
                ...
                vt(t.arrowElement, t.arrowStyles),
              t
            );
          },
    ...
    Dt = (function () {
      function t(e, n) {
        ...
        $(this, t),
          ...
          Object.keys(nt({}, t.Defaults.modifiers, r.modifiers)).forEach(
            function (e) {
  ...
  var St,
    ...
    Ge =
      ...
      (Ke = ".dropdown-menu"),
      (Ve = { offset: 0, flip: !0, boundary: "scrollParent" }),
      (Qe = {
        ...
        return (
              ...
              if ((t._clearMenus(), !n)) {
                ...
                if ((Le(e).trigger(r), !r.isDefaultPrevented())) {
                  if (!this._inNavbar) {
                    ...
                    var o = this._element;
                    Le(e).hasClass("dropup") &&
                      (Le(this._menu).hasClass("dropdown-menu-left") ||
                        Le(this._menu).hasClass(Be)) &&
                      (o = e),
                      "scrollParent" !== this._config.boundary &&
                        Le(e).addClass("position-static"),
                      (this._popper = new Dt(
                        o,
                        this._menu,
                  ...
                  "ontouchstart" in document.documentElement &&
                    0 === Le(e).closest(".navbar-nav").length &&
          ...
          (e._getPlacement = function () {
            ...
            return (
              t.hasClass("dropup")
                ? ((e = "top-start"),
                  Le(this._menu).hasClass(Be) && (e = "top-end"))
                : t.hasClass("dropright")
                ? (e = "right-start")
                : t.hasClass("dropleft")
                ? (e = "left-start")
                : Le(this._menu).hasClass(Be) && (e = "bottom-end"),
              e
            );
          }),
      ...
      Le(document)
        .on(Me.KEYDOWN_DATA_API, Fe, Ye._dataApiKeydownHandler)
        .on(Me.KEYDOWN_DATA_API, Ke, Ye._dataApiKeydownHandler)
        .on(Me.CLICK_DATA_API + " " + Me.KEYUP_DATA_API, Ye._clearMenus)
        .on(Me.CLICK_DATA_API, Fe, function (t) {
          t.preventDefault(),
            t.stopPropagation(),
        ...
        return (
          ...
          (e.show = function (t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
              O.supportsTransitionEnd() &&
                be(this._element).hasClass(Se) &&
                (this._isTransitioning = !0);
              var n = be.Event(Ae.SHOW, { relatedTarget: t });
          ...
          (e.hide = function (t) {
            ...
            if (
              ...
              if (
                ...
                this._isShown = !1;
                var i =
                  O.supportsTransitionEnd() && be(this._element).hasClass(Se);
          ...
          (e._showElement = function (t) {
            ...
            var i = be.Event(Ae.SHOWN, { relatedTarget: t }),
              r = function () {
          ...
          (e._enforceFocus = function () {
            ...
            be(document)
              ...
              .on(Ae.FOCUSIN, function (e) {
                document !== e.target &&
                  t._element !== e.target &&
                  0 === be(t._element).has(e.target).length &&
                  t._element.focus();
              });
          }),
          (e._setEscapeEvent = function () {
            ...
            this._isShown && this._config.keyboard
              ? be(this._element).on(Ae.KEYDOWN_DISMISS, function (e) {
          ...
          (e._setResizeEvent = function () {
            var t = this;
            this._isShown
              ? be(window).on(Ae.RESIZE, function (e) {
          ...
          (e._removeBackdrop = function () {
            this._backdrop &&
              (be(this._backdrop).remove(), (this._backdrop = null));
          }),
          ...
          (e._resetScrollbar = function () {
            be(Oe.FIXED_CONTENT).each(function (t, e) {
              ...
              void 0 !== n &&
                be(e).css("padding-right", n).removeData("padding-right");
            }),
              be(Oe.STICKY_CONTENT + ", " + Oe.NAVBAR_TOGGLER).each(function (
                t,
                e
              ) {
                var n = be(e).data("margin-right");
                void 0 !== n &&
                  be(e).css("margin-right", n).removeData("margin-right");
              });
            var t = be("body").data("padding-right");
            void 0 !== t &&
              be("body").css("padding-right", t).removeData("padding-right");
          }),
          ...
          (t._jQueryInterface = function (e, n) {
            return this.each(function () {
              ...
              if (
                (i || ((i = new t(this, o)), be(this).data(ye, i)),
                "string" == typeof e)
              ) {
                if (void 0 === i[e])
                  throw new TypeError('No method named "' + e + '"');
        ...
        return (
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              re(r).data(this.constructor.DATA_KEY, this),
                ...
                re(r).addClass(me),
                "ontouchstart" in document.documentElement &&
                  re("body").children().on("mouseover", null, re.noop);
              var c = function () {
              ...
              O.supportsTransitionEnd() && re(this.tip).hasClass(ge)
                ? re(this.tip)
          ...
          (e.hide = function (t) {
            ...
            re(this.element).trigger(i),
              i.isDefaultPrevented() ||
                (re(n).removeClass(me),
                "ontouchstart" in document.documentElement &&
                  re("body").children().off("mouseover", null, re.noop),
                (this._activeTrigger.click = !1),
                (this._activeTrigger[ve] = !1),
                (this._activeTrigger[_e] = !1),
                O.supportsTransitionEnd() && re(this.tip).hasClass(ge)
                  ? re(n).one(O.TRANSITION_END, r).emulateTransitionEnd(150)
                  : r(),
                (this._hoverState = ""));
          }),
          (e.update = function () {
          ...
          (e.setElementContent = function (t, e) {
            ...
            "object" == typeof e && (e.nodeType || e.jquery)
              ? n
                ? re(e).parent().is(t) || t.empty().append(e)
                : t.text(re(e).text())
              : t[n ? "html" : "text"](e);
          }),
          (e.getTitle = function () {
          ...
          (e._enter = function (t, e) {
            ...
            (e = e || re(t.currentTarget).data(n)) ||
              ...
              re(e.getTipElement()).hasClass(me) || e._hoverState === de
                ? (e._hoverState = de)
          ...
          (t._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (n || ((n = new t(this, i)), re(this).data(se, n)),
                "string" == typeof e)
              ) {
                if (void 0 === n[e])
                  throw new TypeError('No method named "' + e + '"');
    ...
    Xe =
      ...
      (ee = r({}, ze.DefaultType, { content: "(string|element|function)" })),
      (ne = {
        HIDE: "hide" + Zt,
        HIDDEN: "hidden" + Zt,
        SHOW: "show" + Zt,
          ...
          (r._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new r(this, n)), qt(this).data(Xt, e)),
                "string" == typeof t)
              ) {
                if (void 0 === e[t])
        ...
        return (
          ...
          (e._getConfig = function (t) {
            if ("string" != typeof (t = r({}, Bt, t)).target) {
              ...
              e || ((e = O.getUID(Ht)), jt(t.target).attr("id", e)),
                (t.target = "#" + e);
            }
          ...
          (e._activate = function (t) {
            ...
            n.hasClass("dropdown-item")
              ? (n.closest(Qt.DROPDOWN).find(Qt.DROPDOWN_TOGGLE).addClass(Vt),
                n.addClass(Vt))
              : (n.addClass(Vt),
                n
                  .parents(Qt.NAV_LIST_GROUP)
                  .prev(Qt.NAV_LINKS + ", " + Qt.LIST_ITEMS)
                  .addClass(Vt),
                n
                  .parents(Qt.NAV_LIST_GROUP)
                  .prev(Qt.NAV_ITEMS)
                  .children(Qt.NAV_LINKS)
                  .addClass(Vt)),
      ...
      (Rt = (function () {
        ...
        return (
          (e.show = function () {
            ...
            if (
              !(
                (this._element.parentNode &&
                  this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                  St(this._element).hasClass(Lt)) ||
                St(this._element).hasClass("disabled")
              )
            ) {
              var e,
                n,
              ...
              var s = St.Event(kt.HIDE, { relatedTarget: this._element }),
                a = St.Event(kt.SHOW, { relatedTarget: n });
              if (
                (n && St(n).trigger(s),
                ...
                var l = function () {
                  var e = St.Event(kt.HIDDEN, { relatedTarget: t._element }),
                    i = St.Event(kt.SHOWN, { relatedTarget: n });
          ...
          (e._activate = function (t, e, n) {
            var i = this,
              r = (
                "UL" === e.nodeName ? St(e).find(xt) : St(e).children(Pt)
              )[0],
            ...
            r && o
              ? St(r).one(O.TRANSITION_END, s).emulateTransitionEnd(150)
              : s();
          }),
